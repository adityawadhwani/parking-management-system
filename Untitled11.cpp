#include<iostream>
#include<process.h>
#include<stdlib.h>                       //class and object
using namespace std;
class Parking                       
{
protected:                            //access specifier are to be used
	int amount;
	int Count;
	int two,three,four;
public:
...
class TwoWheel:virtual public Parking           // hirarchicale inheritance used in this project
{
public:
    void t_wheel()
	{
